...
链切换好之后，打开发币页面：<https://ccbus.cc/create-token/lp-with-inviter>点击右上角连接钱包
...
钱包连接成功后，我们通过PandaTool可视化页面开启创建，打开<https://ccbus.cc/create-token/lp-with-inviter>，填写相应的参数：
