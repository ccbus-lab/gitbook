...
根据以下步骤，您可以在可支持的任意一条链上，创建一个标准合约代币。以BSC为例。
  ...
  * 注意：没有安装小狐狸钱包的不能发币，请先安装小狐狸钱包插件，教程：<metamask.md>


## 2、连接钱包

使用浏览器或者钱包打开网址：<https://ccbus.cc/create-token/standard>，点击右上角，将小狐狸钱包切换到币安主网（BSC）

![](../../images/createtoken/standard/p-01.png)
...
我们进入到PandaTool创建资金池工具的网页：<https://ccbus.cc/liquidity-control/create-liquidity> 然后在右上角点击连接钱包
