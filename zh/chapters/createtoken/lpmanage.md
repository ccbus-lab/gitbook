...
如果您已经在Pancake薄饼或者Uniswap创建了一个流动性资金池，该如何看到自己的池子呢？通过我们的[流动性控制台](https://ccbus.cc/liquidity-control/lp-manage)查看，如下图所示：
...
首先，我们进入PandaTool的流动性控制台 <https://ccbus.cc/liquidity-control/lp-manage> ，然后右上角连接钱包，并选择对应的区块链
