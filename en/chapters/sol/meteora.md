...
传统意义上，如果我们要让一个Solana代币的价格保持稳定，可以创建Raydium CLMM稳定池。关于这种类型的资金池，PandaTool有详细的创建教程与工具
  ...
  * Raydium CLMM稳定池创建工具：<https://solana.pandatool.org/createpool>

  * Raydium CLMM稳定池创建教程：<https://help.pandatool.org/sol/clmm>
...
第一步，我们需要打开PandaTool的DLMM流动性创建工具：<https://solana.pandatool.org/meteora> ，或者从菜单栏打开，也能进入
