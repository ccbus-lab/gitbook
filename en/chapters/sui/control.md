...
首先，我们打开代币的权限管理页面：<https://sui.pandatool.org/control> ，右上角连接钱包后，点击`冻结/解冻账户`按钮。
...
具体该怎么使用呢？首先，我们打开控制台链接：<https://sui.pandatool.org/control> ，右上角连接钱包（这一步之大家应该很熟悉了），连接成功后右上角能看到钱包地址
...
和增发一样，我们打开PandaTool的代币控制页面：<https://sui.pandatool.org/control> ，首先要连接钱包（这一步就不演示了），然后点击**更新资料** 按钮
